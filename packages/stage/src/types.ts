...
export interface LitSquareStageAudioModule {
...
export interface LitSquareStageSketch {
  setup?: (ctx: FrameContext, root: HTMLElement) => Awaitable<void>;
  prepareExport?: (ctx: FrameContext, root: HTMLElement) => Awaitable<void>;
  renderFrame: (ctx: FrameContext, root: HTMLElement) => Awaitable<void>;
  finishExport?: (ctx: FrameContext, root: HTMLElement) => Awaitable<void>;
