# LitSquare Stage Public Runtime Contract
...
- Public API stability matters. Any exported symbol from `@litsquare/stage`, `@litsquare/stage-react`, or `@litsquare/stage-protocol` must be intentional, documented, and covered by type checks.
